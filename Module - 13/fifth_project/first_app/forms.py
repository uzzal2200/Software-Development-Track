...
class contactForm(forms.Form):
    name = forms.CharField(label  = "User Name : ",initial="Rahim", help_text = "Total length must be within 70 characters", required=False,widget=forms.Textarea(attrs={'id': 'text_area','class' : 'class1 class2', 'placeholder' : 'Enter your name'}))
    ...
    CHOICES = [('S','samll'),('M', 'Meduim'),('L','Large')]
    size = forms.ChoiceField(choices=CHOICES,widget=forms.RadioSelect)
    MEAL = [('P','pepperoni'),('M','Mashrom'),('B',('Beef'))]
